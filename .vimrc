...
set autoread
" Reduce update time to check for external changes more frequently (250ms instead of default 4000ms)
set updatetime=250

" Trigger checktime more frequently to detect external changes
